...
const WAVES_S5: WaveDef[] = [
  { id: 1, prepTime: 24, reward: 68, groups: [g('grunt', 6, 0.7), g('runner', 5, 0.7, 3, 1)] },
  { id: 2, prepTime: 18, reward: 68, groups: [g('grunt', 7, 0.65), g('runner', 6, 0.7, 4, 1)] },
  {
    id: 3,
    prepTime: 18,
    reward: 75,
  ...
  },
  {
    ...
    prepTime: 20,
    reward: 111,
    warning: '철기와 간자 — 화차도 화약도 답이 아닙니다',
    groups: [g('sentinel', 3, 1.4), g('shieldman', 5, 1.0, 4, 1), g('grunt', 13, 0.55, 8), g('warlock', 4, 1.0, 12)],
  },
  {
    id: 8,
    prepTime: 26,
  ...
  },
  {
    ...
    prepTime: 22,
    reward: 164,
    groups: [g('brute', 5, 1.2), g('shieldman', 8, 0.7, 4, 1), g('shaman', 11, 0.5, 8), g('warlock', 5, 0.95, 12)],
  },
  {
    id: 14,
    prepTime: 22,
