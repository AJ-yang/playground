...
export const ENEMY_ART: Record<string, Art> = {
   ...
   * 고블린 대왕 우르그 — 첫 보스.
   *
   * 고블린과 **같은 종족으로 읽혀야** 한다. 잡병을 상대하던 사람이 "저건
   * 저놈들의 두목이구나"를 형태만으로 알아야 하기 때문에, 뾰족한 귀와 초록
   * 피부는 유지하고 몸집·왕관·거대한 식칼로 격을 올렸다.
   */
  goblinking: [
    { d: 'M9 27 L8 30 M23 27 L24 30', stroke: LEATHER_DARK, width: 3.2 },
    // 불룩한 몸통
    { d: 'M7.5 27 Q5.5 14 16 14 Q26.5 14 24.5 27 Z', fill: '@color' },
    { d: 'M11 26.5 Q10 18.5 16 18.5 Q22 18.5 21 26.5 Z', fill: LEATHER },
    { d: 'M11.6 22 L20.4 22', stroke: '#c9a227', width: 1.4 },
    { d: 'M16 22 A1.8 1.8 0 1 1 16.1 22 Z', fill: '#f0c674' },
    // 어깨 가시 갑옷
    { d: 'M5 17 Q6.5 11.5 11.5 14 Q9 16.5 8.4 19.5 Z', fill: METAL_DARK },
    { d: 'M27 17 Q25.5 11.5 20.5 14 Q23 16.5 23.6 19.5 Z', fill: METAL_DARK },
    { d: 'M6.4 13.6 L5 9.4 L9.4 12.4 Z M25.6 13.6 L27 9.4 L22.6 12.4 Z', fill: BONE },
    // 큰 머리와 뾰족한 귀
    { d: 'M10.6 8.6 L5 4.8 L10 11.6 Z M21.4 8.6 L27 4.8 L22 11.6 Z', fill: '@color' },
    { d: 'M10 8.6 A6 6 0 1 1 22 8.6 A6 6 0 1 1 10 8.6 Z', fill: '@color' },
    { d: 'M12.4 9.6 L14 9.6 M18 9.6 L19.6 9.6', stroke: '#1a1208', width: 2 },
    { d: 'M12.8 12.4 L14.4 11 L15.6 12.4 L17 11 L18.2 12.4 L19.6 11', stroke: '#e8dcc0', width: 1.3 },
    // 왕관 — 첫 보스라는 서사를 얹는 유일한 장치
    { d: 'M10.2 5 L11.6 1.2 L13.4 3.4 L16 0.2 L18.6 3.4 L20.4 1.2 L21.8 5 Z', fill: '#f0c674' },
    { d: 'M16 2.6 A1.1 1.1 0 1 1 16.1 2.6 Z', fill: '#c8332f' },
    // 거대한 식칼
    { d: 'M24 26 L28.6 12', stroke: WOOD_DARK, width: 2 },
    { d: 'M28 13.6 L31.6 6.4 L25.6 9 Q26.4 11.8 28 13.6 Z', fill: METAL_LIGHT },
    { d: 'M28 13.6 L31.6 6.4', stroke: METAL, width: 0.8 },
  ],

  /**
   * 공성 골렘 카르낙 — 장갑 보스.
   *
   * "물리로는 안 된다"가 첫눈에 읽혀야 하므로 전신을 판금·석재로 덮고
   * 살결을 하나도 남기지 않았다. 가슴의 붉은 균열이 유일한 약점처럼 보인다.
   */
  golem: [
    { d: 'M9 26 L8 30 L13 30 L13 26 Z M23 26 L24 30 L19 30 L19 26 Z', fill: STONE_DARK },
    // 몸통 — 각진 블록
    { d: 'M7 26 L7 12 L25 12 L25 26 Z', fill: '@color' },
    { d: 'M7 26 L7 12 L12 12 L12 26 Z', fill: METAL_LIGHT, },
    { d: 'M7.5 19 L24.5 19', stroke: STONE_DARK, width: 1 },
    // 가슴의 붉은 균열 — 유일한 색 포인트
    { d: 'M16 13.5 L18 17 L15 19 L17.5 22 L14.5 25.5', stroke: '#ff5c3c', width: 1.6 },
    { d: 'M16 18.5 A3.6 3.6 0 1 1 16.1 18.5 Z', fill: 'rgba(255,92,60,0.28)' },
    // 거대한 어깨 판
    { d: 'M3.5 18 Q3 9.5 11 10.5 L11 15 Q7 15 6.5 18.6 Z', fill: METAL },
    { d: 'M28.5 18 Q29 9.5 21 10.5 L21 15 Q25 15 25.5 18.6 Z', fill: METAL },
    { d: 'M4.4 11.4 L6.6 8 L8.4 11 Z M27.6 11.4 L25.4 8 L23.6 11 Z', fill: METAL_LIGHT },
    // 낮게 박힌 머리 — 목이 없어 더 둔중해 보인다
    { d: 'M11.5 11.5 L11.5 5.5 L20.5 5.5 L20.5 11.5 Z', fill: METAL },
    { d: 'M12.6 7.6 L19.4 7.6 L19.4 9.4 L12.6 9.4 Z', fill: '#12151c' },
    { d: 'M13.6 8.5 L14.8 8.5 M17.2 8.5 L18.4 8.5', stroke: '#ff5c3c', width: 1.5 },
    { d: 'M13.4 5.5 L14.4 2.4 L15.6 5.5 Z M16.4 5.5 L17.6 2.4 L18.6 5.5 Z', fill: METAL_LIGHT },
    // 파성추 팔
    { d: 'M25 20 L30 20', stroke: METAL_DARK, width: 4.2 },
    { d: 'M29 16.6 L31.6 20 L29 23.4 Z', fill: METAL_LIGHT },
  ],

  /**
   * 쌍두 와이번 니드호그 — 공중 보스.
   *
   * 머리가 둘이라는 것 하나로 일반 와이번과 즉시 구분된다. 날개는 렌더러가
   * 뒤에 그리므로 여기서는 몸통·목·꼬리만 담당한다.
   */
  twinwyvern: [
    // 꼬리 — 뒤로 길게 빼서 목 두 개와 균형을 잡는다
    { d: 'M11 20.5 Q6 23.5 2.6 19.5', stroke: '@color', width: 2.8 },
    { d: 'M3.2 20 L0 16.4 L0.4 22.4 Z', fill: BONE },
    // 몸통 — 목이 둘이라 상체를 두껍게
    { d: 'M9 19 Q9 12 16 12 Q23 12 23 19 Q23 24.2 16 24.2 Q9 24.2 9 19 Z', fill: '@color' },
    { d: 'M11.4 20.4 Q16 24.4 20.6 20.4 Q20 23.2 16 23.2 Q12 23.2 11.4 20.4 Z', fill: 'rgba(255,255,255,0.26)' },
    { d: 'M12 13.4 L11 10 L14.2 12.4 Z M16.6 12.2 L16.4 8.6 L19.4 12.2 Z', fill: BONE },
    // 위쪽 목 — 크게 휘어 위로 솟는다
    { d: 'M19.4 14.4 Q25.6 13.4 26.4 6.4', stroke: '@color', width: 2.5 },
    // 위쪽 머리 — 벌린 턱
    { d: 'M24 6 Q25.4 2.2 29 3 L31.2 5.4 L27.2 7 Q24.8 7 24 6 Z', fill: '@color' },
    { d: 'M27.4 6.6 L31.4 5.6 L30.6 8 L27.8 8.6 Z', fill: '@color' },
    { d: 'M25.2 3.8 L23 0.6 L27.2 2.6 Z', fill: BONE },
    { d: 'M28.2 5 L29.4 4.8', stroke: '#0e1a1c', width: 1.2 },
    // 아래쪽 목 — 반대로 낮게 뻗는다
    { d: 'M20.2 19.6 Q26.6 20 28.4 15.2', stroke: '@color', width: 2.5 },
    // 아래쪽 머리
    { d: 'M26.2 15.2 Q27.4 11.6 31 12.4 L31.8 15 L28 16.4 Q26.6 16.4 26.2 15.2 Z', fill: '@color' },
    { d: 'M28.2 16 L31.8 15.2 L31.2 17.4 L28.6 18 Z', fill: '@color' },
    { d: 'M27.2 13 L25.2 9.8 L29.2 11.8 Z', fill: BONE },
    { d: 'M29.6 14 L30.8 13.8', stroke: '#0e1a1c', width: 1.2 },
    // 움츠린 뒷다리
    { d: 'M12.6 23.6 L11.2 27.4 M19.4 23.6 L20.8 27.4', stroke: '@color', width: 2.1 },
    { d: 'M9.8 27.6 L12.8 27 M19.4 27.2 L22.4 27.8', stroke: BONE, width: 1.3 },
  ],

  /**
   * 주술 대모 모르가 — 마법저항 보스.
   *
   * 주술사와 같은 로브 계열이되 훨씬 크고, 뿔 달린 가면과 떠다니는 해골로
   * "이건 더 강한 주술사다"를 말한다. 물리로 때려야 하는 상대다.
   */
  hexmother: [
    // 로브 — 위아래로 뾰족한 마름모를 더 길게
    { d: 'M16 0.5 L26 16 L21.5 30 L10.5 30 L6 16 Z', fill: '@color' },
    { d: 'M16 2.5 L16 30', stroke: 'rgba(0,0,0,0.24)', width: 1 },
    { d: 'M9.4 22 L22.6 22 M10.6 26 L21.4 26', stroke: 'rgba(0,0,0,0.18)', width: 0.9 },
    // 뿔 달린 가면
    { d: 'M16 2.4 L23 13.5 Q16 17.4 9 13.5 Z', fill: '#1b0f24' },
    { d: 'M10.4 8 L6.6 3.4 L12.4 6.2 Z M21.6 8 L25.4 3.4 L19.6 6.2 Z', fill: BONE },
    { d: 'M12.8 11.4 L15 11.4 M17 11.4 L19.2 11.4', stroke: '#ffe08a', width: 2 },
    { d: 'M14.4 14 L17.6 14', stroke: '#ffe08a', width: 1.1 },
    // 가슴의 룬
    { d: 'M16 17.6 L19.4 21.4 L16 25.2 L12.6 21.4 Z', stroke: 'rgba(255,255,255,0.55)', width: 1.2 },
    { d: 'M16 19.6 A1.6 1.6 0 1 1 16.1 19.6 Z', fill: '#ffe08a' },
    // 해골 지팡이
    { d: 'M27.4 29 Q25.4 18 27.2 8.4', stroke: WOOD_DARK, width: 1.8 },
    { d: 'M24.6 7 Q27.2 3.4 29.8 7 Q29.8 10 27.2 10.4 Q24.6 10 24.6 7 Z', fill: BONE },
    { d: 'M25.8 7 L26.8 7 M27.8 7 L28.8 7', stroke: '#2a1f14', width: 1.2 },
    { d: 'M26.2 9.4 L28.2 9.4', stroke: '#2a1f14', width: 0.8 },
    // 떠다니는 넋
    { d: 'M4.4 11 A1.9 1.9 0 1 1 4.5 11 Z', fill: 'rgba(255,224,138,0.85)' },
    { d: 'M5.6 19.6 A1.3 1.3 0 1 1 5.7 19.6 Z', fill: 'rgba(255,224,138,0.7)' },
  ],

  /**
   * 서리 거인 요툰 — 양면 저항 보스.
   *
   * 장갑과 마법저항을 동시에 가진 탱커라 어느 한쪽으로는 못 뚫는다. 그래서
   * 얼음 갑옷(물리 방어)과 등의 마력 결정(마법 방어)을 **둘 다** 보여준다.
   */
  frostgiant: [
    { d: 'M10.5 25 L9 30 M21.5 25 L23 30', stroke: '#3f5a72', width: 3.6 },
    // 등의 얼음 결정 — 마법 저항의 근거
    { d: 'M6 15 L3.4 6.6 L9.6 12.4 Z M25.4 13 L28.6 5.6 L22.6 11 Z', fill: '#9fe4f5' },
    { d: 'M8.6 9.4 L7.6 2.6 L12 8 Z', fill: '#cdf1fb' },
    // 몸통
    { d: 'M6.5 26 Q4.5 11 16 11 Q27.5 11 25.5 26 Z', fill: '@color' },
    { d: 'M10.5 25.5 Q9.5 16 16 16 Q22.5 16 21.5 25.5 Z', fill: 'rgba(255,255,255,0.2)' },
    // 얼음 갑옷 판 — 물리 방어의 근거
    { d: 'M9 15.5 L14 13.4 L15 17.4 L10 19.4 Z M23 15.5 L18 13.4 L17 17.4 L22 19.4 Z', fill: '#b9e6f4' },
    { d: 'M12.4 21 L19.6 21 L18.6 25 L13.4 25 Z', fill: '#b9e6f4' },
    // 머리와 서리 수염
    { d: 'M10.6 7.4 A5.4 5.4 0 1 1 21.4 7.4 A5.4 5.4 0 1 1 10.6 7.4 Z', fill: '@color' },
    { d: 'M11.4 8.6 Q16 15.4 20.6 8.6 Q20 12.8 16 13.6 Q12 12.8 11.4 8.6 Z', fill: '#e6f6fb' },
    { d: 'M12.8 7 L14.6 7 M17.4 7 L19.2 7', stroke: '#2e6f8c', width: 2 },
    { d: 'M11.4 4.4 L8.4 0.6 L14 3.2 Z M20.6 4.4 L23.6 0.6 L18 3.2 Z', fill: '#cdf1fb' },
    // 얼음 곤봉
    { d: 'M25 22 L29 14', stroke: '#3f5a72', width: 2.4 },
    { d: 'M29.4 13.4 L26 9.4 L31.6 7.4 L31.8 12.6 Z', fill: '#9fe4f5' },
    { d: 'M29.4 13.4 L31.6 7.4', stroke: '#e6f6fb', width: 1 },
  ],
