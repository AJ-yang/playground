...
/**
 * 안주 벌판 — 두 갈래가 중간에 합류한다.
 *
 * 정묘호란에서 후금 기병은 압록강을 건너 의주를 지나 안주로 내려왔다. 두
 * 출발점이 곧 합류해 **한 갈래로 뭉치는** 구조라, 앞쪽은 커버리지가 갈리고
 * 뒤쪽은 물량이 겹친다 — 앞뒤에 서로 다른 답을 요구한다.
 */
export const LEVEL_ANJU: LevelDef = {
  id: 'anju',
  name: '안주 벌판',
  cols: COLS,
  rows: ROWS,
  routes: [
    [v(-1, 2), v(6, 2), v(6, 7), v(13, 7), v(13, 12), v(19, 12), v(19, 5), v(24, 5)],
    [v(-1, 12), v(6, 12), v(6, 7), v(13, 7), v(13, 12), v(19, 12), v(19, 5), v(24, 5)],
  ],
  blocked: [
    v(2, 5), v(3, 5), v(2, 6),
    v(9, 2), v(10, 2), v(9, 3),
    v(9, 10), v(10, 10),
    v(16, 2), v(16, 3), v(17, 3),
    v(21, 9), v(22, 9), v(22, 10),
    v(3, 9), v(4, 9),
  ],
}
